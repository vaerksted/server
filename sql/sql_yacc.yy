...
default_charset:
          opt_default charset opt_equal charset_name_or_default
          {
            if (unlikely(Lex->create_info.add_table_option_default_charset(
                           thd->variables.character_set_collations, $4)))
              MYSQL_YYABORT;
          }
        ;
...
field_type_or_serial:
          ...
          field_def
          {
            ...
            if (tmp.merge_column_charset_clause_and_collate_clause(
                      thd->variables.character_set_collations, $3))
              MYSQL_YYABORT;
...
attribute_list:
          ...
          {
             if (($$= $1).merge_column_collate_clause_and_collate_clause(
                            thd->variables.character_set_collations, $2))
               MYSQL_YYABORT;
          }
        | attribute
        ;
...
alter_list_item:
	...
	| DROP CONSTRAINT opt_if_exists_table_element field_ident
        ...
        | CONVERT_SYM TO_SYM charset charset_name_or_default
          ...
          {
            if (Lex->add_alter_list_item_convert_to_charset(
                       thd->variables.character_set_collations, $4, $6))
              MYSQL_YYABORT;
          }
        | create_table_options_space_separated
          {
...
string_dyncol_type:
          char opt_binary
          {
            if ($$.set(DYN_COL_STRING, thd->variables.character_set_collations,
        ...
        | CHAR_SYM opt_field_length opt_binary
          {
            if ($$.set(&type_handler_long_blob,
                       $2, thd->variables.character_set_collations, $3,
        ...
        | NAMES_SYM charset_name_or_default
          {
            ...
            if (tmp.merge_collation(thd->variables.
