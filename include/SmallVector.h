...
#define LLVM_NODISCARD /* empty */
#define LLVM_GSL_OWNER /* empty */
...
protected:
  ...
  static void uninitialized_copy(
      T1 *I, T1 *E, T2 *Dest,
      std::enable_if<std::is_same<typename std::remove_const<T1>::type,
                                  T2>::value> * = nullptr) {
...
private:
  template <class ArgType> iterator insert_one_impl(iterator I, ArgType &&Elt) {
    ...
    static_assert(
        std::is_same<std::remove_const<std::remove_reference<ArgType>>,
                     T>::value,
    ...
    std::remove_reference<ArgType> *EltPtr =
